...
type VehicleServiceClient interface {
	...
	ListVehicles(ctx context.Context, in *Void, opts ...grpc.CallOption) (*Vehicle, error)
...
func (c *vehicleServiceClient) ListVehicles(ctx context.Context, in *Void, opts ...grpc.CallOption) (*Vehicle, error) {
	out := new(Vehicle)
...
type VehicleServiceServer interface {
	...
	ListVehicles(context.Context, *Void) (*Vehicle, error)
...
func (UnimplementedVehicleServiceServer) ListVehicles(context.Context, *Void) (*Vehicle, error) {
